...
st.subheader("Where are you in singapore?")
...
lon = st.number_input("longitude", min_value=103.5, max_value=104.1, value=103.800, step=0.005, format="%.3f", key=None, help='Input longitude between 103.5 < long < 104.1', on_change=None)
...
if not hawkers:
    st.text("No hawkers found, try another location")
